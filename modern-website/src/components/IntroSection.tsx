              ...
              <div className="mt-6">
                ...
                <div className="mt-8 grid gap-6 lg:grid-cols-[1.26fr_0.74fr] xl:grid-cols-[1.3fr_0.7fr]">
                  ...
                  <div className="self-start justify-self-end w-full max-w-[21.5rem] space-y-4">
                    ...
                    <article className="warm-hover-glow rounded-[1.3rem] border border-[#d8a08d]/30 bg-[linear-gradient(180deg,rgba(255,255,255,0.84),rgba(255,244,238,0.66))] p-4 shadow-[0_14px_28px_rgba(179,93,76,0.08)] sm:p-5">
                      <div className="flex h-[11rem] items-center justify-center overflow-hidden rounded-[1.16rem] border border-[#d8a08d]/24 bg-[rgba(255,250,246,0.78)]">
                        <img
                          src={kundImg}
                          alt={locale === 'de' ? 'Kundalini-Symbolik' : 'Kundalini symbolism'}
                          className="h-auto max-h-full w-[70%] object-contain"
                        />
                      </div>
                    </article>
                  </div>
