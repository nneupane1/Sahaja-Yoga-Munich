    ...
    locale === 'de'
        ? {
          ...
          meaningCard: {
            ...
            paragraphs: [
              'Im Herzen von Sahaja Yoga steht das Erwachen der Kundalini, die im dreieckigen Kreuzbein in dreieinhalb Windungen ruht wie eine mitgeborene mütterliche Kraft, die lange darauf gewartet hat, uns durch ihr Erwachen eine zweite Geburt des Geistes zu schenken. Die Kundalini ist dieselbe wunderbare göttliche Kraft, die das Kind im Mutterleib wachsen lässt und folgerichtig im Kreuzbein in dreieinhalb Windungen niedergelegt ist; sie stellt jene kosmische Energie dar, durch die in jedem Menschen ein inneres Universum gebildet wird. Wenn die Kundalini durch den zentralen Sushumna-Kanal aufsteigt, führt sie das Bewusstsein allmählich in den Zustand gedankenfreier Stille in der Meditation, während sie zugleich die linke Ida- und die rechte Pingala-Seite ins Gleichgewicht bringt und die Chakren von innen her klärt. In diesem Zustand ist Meditation nicht länger etwas, das man als Praxis macht; sie wird mühelos und spontan und offenbart sich als ein lebendiger spiritueller Zustand. Darin liegt die tiefere Bedeutung von Yoga: nicht eine von außen auferlegte Technik, sondern eine natürliche Vereinigung, die von innen entsteht.',
              ...
              'Wenn die Kundalini durch die Chakren aufsteigt, die oft als subtile Räder in fortwährender Bewegung beschrieben werden, kann sie auf Negativitäten oder Blockaden stoßen, die in den jeweiligen Chakren gelagert sind. Gerade diese Reibung zwischen der aufsteigenden Kundalini und jenen Unreinheiten in den rotierenden Chakren kann Wärme erzeugen, die sich gewöhnlich an den Fingerkuppen oder am Scheitel bemerkbar macht; eine solche Wärme wird nicht als Problem verstanden, sondern als ein schönes Zeichen dafür, dass Reinigung geschieht. Weil sich Chakren und Kanäle in den Händen widerspiegeln, kann diese subtile Arbeit in der Meditation auch als Kribbeln oder Kühle an den Händen oder anderen Körperstellen oder, für viele Suchende, als sanfte kühle Brise vom Scheitel erfahrbar werden. Auf diese Weise beginnt das subtile System durch Empfindung zu sprechen, sodass sein innerer Zustand in der Meditation nach und nach lesbar und, in einem tieferen Sinn, entschlüsselbar wird.',
              'In dieser Stille ist Meditation nicht länger erzwungen. Sie wird mühelos, spontan und zugleich wacher. Mit vertiefter Praxis wird diese subtile Lesbarkeit immer klarer und resoniert mit jener alten Weisheit, in der Heilige und verwirklichte Wesen die innere Sprache des subtilen Systems zu meistern vermochten.'
            ],
      ...
      : {
          ...
          meaningCard: {
            ...
            paragraphs: [
              'At the heart of Sahaja Yoga lies the awakening of Kundalini, resting within the triangular sacrum bone in three and a half coils as an inborn motherly energy that has long been waiting to grant us our second birth through its awakening. Kundalini is the same miraculous Divine force that allows the baby to grow within the mother’s womb and is consequentially encoded inside the sacrum bone in 3.5 coils, representing the cosmic energy through which an inner universe is formed within each human being. As Kundalini rises through the central Sushumna channel, it gradually draws consciousness into the state of Thoughtless Awareness in meditation, while balancing the left Ida and right Pingala channels and clearing the chakras from within. In that state meditation is no longer something one tries to do as a practice; it becomes effortless and spontaneous, revealing itself as a living spiritual state. This is the deeper meaning of Yoga: not a technique imposed from outside, but a natural union arising from within.',
              ...
              'As Kundalini rises through the chakras, often described as subtle wheels in continuous motion, it may encounter negativities or obstructions lodged within the respective chakras. It is this friction between the ascending Kundalini and those impurities in the rotating chakras that can generate heat, usually felt on the fingertips or at the top of the head; such warmth is understood not as a problem, but as a beautiful sign that cleansing is taking place. Because the chakras and channels are reflected in the hands, this subtle working may also be experienced in meditation as tingling, coolness on hands or body parts, for many seekers, as a gentle Cool Breeze flowing from the crown of the head. In this way the subtle system begins to speak through sensation, allowing its inner state to become gradually readable and, in a deeper sense, decodable in meditation.',
              'In that stillness, meditation is no longer forced. It becomes effortless, spontaneous and at the same time more awake. With dedicated practice this subtle readability grows clearer, resonating with the ancient wisdom in which saints and realized beings were said to have mastered the inner language of the subtle system.'
            ],
                ...
                <div className="mt-8 grid gap-6 lg:grid-cols-[1.26fr_0.74fr] xl:grid-cols-[1.3fr_0.7fr]">
                  ...
                  <div className="self-start justify-self-end w-full max-w-[21.5rem] space-y-4">
                          ...
                          <div className="absolute inset-0 overflow-hidden rounded-[1.16rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(255,248,244,0.88))] transform-gpu [-webkit-backface-visibility:hidden] [backface-visibility:hidden]">
                            <div className="absolute inset-0 flex items-center justify-center rounded-[1.16rem] border border-[#d8a08d]/24 bg-[#f6edb8] p-0">
                              <img
                                ...
                                className="h-full w-full -translate-y-1 rounded-[1.14rem] object-contain scale-[1.01]"
                              />
                            </div>
                          </div>
                    ...
                    <article className="warm-hover-glow rounded-[1.3rem] border border-[#d8a08d]/30 bg-[linear-gradient(180deg,rgba(255,255,255,0.84),rgba(255,244,238,0.66))] p-3 shadow-[0_14px_28px_rgba(179,93,76,0.08)] sm:p-3.5">
                      <div className="flex h-[7.15rem] items-center justify-center overflow-hidden rounded-[1.16rem] border border-[#d8a08d]/24 bg-[rgba(255,250,246,0.78)]">
                        <img
                          src={kundImg}
                          alt={locale === 'de' ? 'Kundalini-Symbolik' : 'Kundalini symbolism'}
                          className="h-[79%] max-w-[51%] -translate-y-0.5 rounded-[0.98rem] object-contain"
                        />
                      </div>
                    </article>
                  </div>
