...
const TopicPage: React.FC<TopicPageProps> = ({ page }) => {
  ...
  const heroImageLeft =
    page.route === '/kundalini-energiesystem' || page.route === '/kultur-des-geistes';
  ...
  const heroPanelPositionClassName = isKundaliniPage
    ? 'slide-ready-right lg:ml-3 lg:mr-0 lg:mt-4 xl:ml-6'
    : isSciencePage
      ? heroImageLeft
                  ...
                  <div
                    className={
                      isKundaliniPage
                        ...
                        : 'absolute inset-x-8 bottom-8 max-w-xl rounded-[1.45rem] border border-[#b35d4c]/28 bg-[rgba(255,250,246,0.92)] p-5 shadow-[0_18px_40px_rgba(72,110,140,0.14)] backdrop-blur'
                    }
                  >
                    <p
                      className={
